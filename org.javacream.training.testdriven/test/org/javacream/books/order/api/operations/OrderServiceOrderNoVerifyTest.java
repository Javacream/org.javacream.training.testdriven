...
public class OrderServiceOrderNoVerifyTest {
	...
	public void validIsbnAndCustomerCreatesOrder() {
		OrderServiceCreator orderServiceCreator = () -> {
			...
			Mockito.when(customerService.findCustomerByName(Mockito.anyString())).thenReturn(CUSTOMER);
			...
			orderServiceImpl.setInvoiceService(billingService);
